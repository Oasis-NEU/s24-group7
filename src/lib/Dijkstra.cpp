...
int main() {
    ...
    int graph[V][V] = {
        {00,60,00,00,00,00,00,00,00,00,00,00,00,00,00}, // SNELL GROUND (0)
        {60,00,55,00,00,00,00,00,00,00,00,00,00,00,00}, // SWEESS INTERSECTION (1)
        {00,55,00,18,00,00,00,00,00,00,00,00,00,00,00}, // CHURCHILL TUNNEL (2)
        {00,00,18,00,55,00,00,00,00,00,00,00,00,00,00}, // SNELL TUNNEL (3)
        {00,00,00,55,00,35,35,15,00,00,00,00,00,00,00}, // HAYDEN INTERSECTION (4)
        {00,00,00,00,35,00,22,00,00,00,00,00,00,00,00}, // HAYDEN DUNKIN' (5)
        {00,00,00,00,35,22,00,00,00,00,00,00,00,00,00}, // RICHARDS GROUND (6)
        {00,00,00,00,15,00,00,00,18,38,30,00,00,00,00}, // ELL TUNNEL RIGHT (7)
        {00,00,00,00,00,00,00,18,00,00,30,00,00,00,00}, // ELL GROUND RIGHT (8)
        {00,00,00,00,00,00,00,38,00,00,30,00,00,00,00}, // CURRY SERVICE DESK (9)
        {00,00,00,00,00,00,00,30,00,00,00,20,44,30,00}, // ELL TUNNEL LEFT (10)
        {00,00,00,00,00,00,00,00,00,00,20,00,00,00,00}, // ELL GROUND LEFT (11)
        {00,00,00,00,00,00,00,00,00,00,44,00,00,00,00}, // MUGAR GROUND (12)
        {00,00,00,00,00,00,00,00,00,00,30,00,00,00,22}, // DODGE TUNNEL (13)
        {00,00,00,00,00,00,00,00,00,00,00,00,00,22,00}, // DODGE GROUND (14)
	};
